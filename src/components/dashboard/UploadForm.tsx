  ...
  if (status === "queued") {
    return (
      <div className="card grid place-items-center py-16 text-center">
        ...
        <p className="mt-4 text-lg font-bold">&ldquo;{file?.name}&rdquo; is in the engine</p>
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button
            onClick={() => { setFile(null); setStatus("idle"); setMsg(""); }}
            className="btn-ghost"
          >
            Upload another
          </button>
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
      <div className="space-y-5">
        ...
        <button onClick={submit} disabled={!file || status === "submitting"} className="btn-primary px-6 py-3 text-base disabled:opacity-40">
